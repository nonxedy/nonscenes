...
class PostgreSQLCutsceneDatabaseService(
    ...
    private val logger = java.util.logging.Logger.getLogger("nonscenes-db-postgres")
    ...
    override fun initialize() {
        try {
            ...
            logger.info("PostgreSQL database initialized at: $host:$port/$database")
        } catch (e: Exception) {
            logger.severe("Failed to initialize PostgreSQL database: ${e.message}")
            throw RuntimeException("Failed to initialize PostgreSQL database", e)
        }
    }
    ...
    override fun shutdown() {
        try {
            ...
            logger.log(Level.WARNING, "Error closing PostgreSQL connection", e)
        }
    }
    ...
    private fun createTables() {
        ...
        try {
            ...
            logger.severe("Failed to create PostgreSQL tables: ${e.message}")
